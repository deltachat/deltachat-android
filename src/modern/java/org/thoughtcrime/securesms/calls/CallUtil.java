...
public class CallUtil {
  ...
  public static void startAudioCall(Context context, @Nullable Activity activity, int chatId) {
    Log.d(TAG, "Starting audio call to " + chatId);
    startCall(context, chatId, false);
  }

  public static void startVideoCall(Context context, @Nullable Activity activity, int chatId) {
  ...
  public static void startOutgoingCallFromMessage(Context context, int accId, int chatId, CallInfo callInfo) {
    if (callInfo.hasVideo) {
      CallUtil.startVideoCall(context, null, chatId);
    } else {
      CallUtil.startAudioCall(context, null, chatId);
    }
  }
}
