...
public class SelectedContactsAdapter extends BaseAdapter {
  ...
  public View getView(final int position, View v, final ViewGroup parent) {
    ...
    if(contactId == DC_CONTACT_ID_ADD_MEMBER) {
      name.setText(context.getString(isChannel? R.string.add_recipients : R.string.group_add_members));
    ...
    if (contact != null && contact.isVerified) {
      ...
      name.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.ic_outline_email,0);
