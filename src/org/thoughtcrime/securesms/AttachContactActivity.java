...
public class AttachContactActivity extends PassphraseRequiredActionBarActivity {
  ...
  public void onCreate(Bundle bundle, boolean ready) {
    ...
    initFragment(android.R.id.content, new AttachContactFragment(), null, getIntent().getExtras());
  }
  ...
  public static class AttachContactFragment
          extends Fragment
    ...
    private void restartLoader() {
      getLoaderManager().restartLoader(0, null, AttachContactFragment.this);
    }
    ...
    private void shareContact(String name, String mail) {
      ...
      intent.putExtra(AttachContactActivity.SHARE_CONTACT_NAME_EXTRA, name);
      intent.putExtra(AttachContactActivity.SHARE_CONTACT_MAIL_EXTRA, mail);
