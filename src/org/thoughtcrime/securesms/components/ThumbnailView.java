...
public class ThumbnailView extends FrameLayout {
  ...
  public ThumbnailView(final Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      ...
      radius             = typedArray.getDimensionPixelSize(R.styleable.ThumbnailView_thumbnail_radius, getResources().getDimensionPixelSize(R.dimen.message_corner_radius));
      typedArray.recycle();
    } else {
      radius = getResources().getDimensionPixelSize(R.dimen.message_corner_radius);
    }
